 ...
 *
 * Answers that send the reader somewhere carry that destination in `links`
 * rather than only describing it in prose, so the FAQ is actionable in place.
 * Every href is a key into `event.urls`: nothing here holds its own URL.
 */
export const faq: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "QFF26 is hybrid: some events are hosted in person in Bengaluru and Kochi, and others run online. Each event lists its own location in the program.",
    confirmed: true,
  },
  {
    id: "tickets",
  ...
  },
  {
    ...
    links: [
      { label: "Apply to speak", href: "speakerApplication" },
  ...
  },
  {
    ...
    links: [{ label: "Partner with us", href: "sponsor" }],
    confirmed: true,
  },
];
